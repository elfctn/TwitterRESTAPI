...
@Table(name = "retweets", uniqueConstraints = {@UniqueConstraint(columnNames = {"user_id", "original_tweet_id"})}) // Veritabanındaki tablo adını "retweets" olarak belirler.
...
public class Retweet {
    ...
    @ManyToOne(fetch = FetchType.LAZY) // Bir retweetin sadece bir kullanıcısı vardır.
    ...
    @ManyToOne(fetch = FetchType.LAZY) // Bir retweetin sadece bir orijinal tweete aittir.
